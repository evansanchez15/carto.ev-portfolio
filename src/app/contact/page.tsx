      ...
      <div className="max-w-4xl ml-3 sm:ml-4 md:ml-6 px-3 sm:px-4 md:px-6 py-8 sm:py-12 md:py-16">
        <div className="grid grid-cols-1 md:grid-cols-2 gap-6 sm:gap-8 md:gap-12 items-start">
          ...
          <div>
            ...
            <form 
              action={`mailto:evanmsanchez15@gmail.com`}
              method="GET"
              className="space-y-6"
            >
              {/* Name Field */}
              ...
              <button
                type="submit"
                className="bg-[#424242] text-white px-8 py-3 rounded-lg text-[16px] font-bold tracking-[0.05em] hover:bg-[#333333] transition-colors"
                style={{ fontFamily: 'Helvetica, Arial, sans-serif' }}
              >
                SEND MESSAGE
              </button>
