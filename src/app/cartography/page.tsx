          ...
          <div className="mx-[20px] sm:mx-[40px] md:mx-[75px] mb-[150px] sm:mb-[200px] md:mb-[250px]">
            ...
            <div className="relative w-full mb-[100px] sm:mb-[130px] md:mb-[170px] overflow-hidden">
              ...
              <div className="flex flex-col sm:flex-row sm:justify-between sm:items-end gap-2 sm:gap-4 overflow-hidden">
                ...
                <p className="text-black text-[8px] sm:text-[10px] md:text-[12px] lg:text-[14px] xl:text-[16px] font-bold leading-none text-right min-w-0 flex-shrink" style={{ fontFamily: 'Helvetica, Arial, sans-serif' }}>
                  QGIS, Adobe Illustrator, Excel
                </p>
              </div>
                  {/* Horizontal line */}
